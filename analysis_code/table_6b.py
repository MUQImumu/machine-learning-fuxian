...
def simulated_tests(real_magnitude, cross_idx, N_train):
    ...
    logdirs = ['../deep_learning/output_RF/' + mode \
               + '/Train_fold_'+str(k)+'/fullnew46591640.950.00.0010.01naturalTestorder'+str(cross_idx) for k in range(1,9)]
    gradients_list = []
...
#    print (">>>>>>>>>>>>>>>>>>>>>>")
#    print ("Generate output for Table 6b (Chronological order case)")
#    print (">>>>>>>>>>>>>>>>>>>>>>")
    text_file = open("tables/Table6b.txt", "wt")
